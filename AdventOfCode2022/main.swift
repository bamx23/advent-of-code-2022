...
func task14_1(_ input: TaskInput) {
    ...
    func mX(_ pos: TaskInput.Task14.Pos) -> Int { pos.x - minX + gap }
    func mY(_ pos: TaskInput.Task14.Pos) -> Int { pos.y - minY + gap }
    
    var map = [[TaskInput.Task14.Tile]](repeating: [TaskInput.Task14.Tile](repeating: .air, count: w + gap * 2), count: h + gap * 2)
    for path in paths {
    ...
    let sandStart: TaskInput.Task14.Pos = (500, 0)
    while true {
        var sand = sandStart
